...
class Applications(BaseModel):
    ...
    group_count: Optional[int] = Field(None, description="Count of ACTIVE application groups (denormalized for display)")
    user_count: Optional[int] = Field(None, description="Count of ACTIVE application group users (denormalized for display)")
    role_count: Optional[int] = Field(None, description="Count of ACTIVE direct user role assignments (denormalized for display)")
