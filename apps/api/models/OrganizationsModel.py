...
class OrganizationsCreateResponse(BaseModel):
    ...
    item: Optional[Organizations] = None


class OrganizationsUpdateResponse(BaseModel):
...
class OrganizationsDisableResponse(BaseModel):
    """Organizations disable response."""
...
class OrganizationsListResponse(BaseModel):
    ...
    success: bool
    message: Optional[str] = None
    items: Optional[List[Organizations]] = None
