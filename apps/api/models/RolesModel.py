...
class RolesCreateResponse(BaseModel):
    ...
    item: Optional[Roles] = None


class RolesUpdateResponse(BaseModel):
...
class RolesDeleteResponse(BaseModel):
...
class RolesDisableResponse(BaseModel):
    """Roles disable response."""
...
class RolesListResponse(BaseModel):
    ...
    success: bool
    message: Optional[str] = None
    items: Optional[List[Roles]] = None
