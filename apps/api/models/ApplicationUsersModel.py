...
# Response Types
class ApplicationUsersCreateResponse(BaseModel):
    """ApplicationUsers create response."""

    code: int
    success: bool
    message: Optional[str] = None
    item: Optional[ApplicationUsers] = None


class ApplicationUsersUpdateResponse(BaseModel):
    """ApplicationUsers update response."""
...
class ApplicationUsersDeleteResponse(BaseModel):
    """ApplicationUsers delete response."""
...
class ApplicationUsersDisableResponse(BaseModel):
    """ApplicationUsers disable response."""
...
class ApplicationUsersGetResponse(BaseModel):
    """ApplicationUsers get response."""
...
class ApplicationUsersListResponse(BaseModel):
    ...
    success: bool
    message: Optional[str] = None
    items: Optional[List[ApplicationUsers]] = None
