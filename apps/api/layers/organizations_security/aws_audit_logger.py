...
class AWSAuditLogger:
    ...
    def _setup_log_groups(self):
        ...
        for log_group, retention_days in self.retention_policies.items():
            try:
                ...
                self.cloudwatch_logs.describe_log_groups(logGroupNamePrefix=log_group)
                ...
                logger.info(
                    f"Created log group {log_group} with {retention_days}-day AWS-managed retention"
                )
    ...
    def _build_audit_entry(
        ...
        return {
            ...
            "target": {
                ...
                "organization_id": target_context.get(
                    "organization_id"
                ),  # Always present for multi-tenant context
    ...
    def _determine_log_group(
        self, event_type: AuditEventType, compliance_flags: List[ComplianceFlag]
    ) -> str:
        ...
        # Financial events go to financial log group (SOX compliance)
            ...
            ("BILLING_", "PAYMENT_", "SUBSCRIPTION_", "INVOICE_", "REFUND_")
        ):
        ...
        return {
            ...
            "change_summary": {
                ...
                "modified_fields": [
                    ...
                    if self._get_nested_value(old_state, f) is not None
                    and self._get_nested_value(new_state, f) is not None
                ],
            },
        }
