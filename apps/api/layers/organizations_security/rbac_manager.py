...
class OrganizationPermissions:
    ...
    ORGANIZATION_READ = Permission(PermissionCategory.ORGANIZATION, "read", "View organization details")
    ORGANIZATION_UPDATE = Permission(PermissionCategory.ORGANIZATION, "update", "Update organization settings")
    ORGANIZATION_DELETE = Permission(PermissionCategory.ORGANIZATION, "delete", "Delete organization")
    ORGANIZATION_TRANSFER = Permission(PermissionCategory.ORGANIZATION, "transfer", "Transfer organization ownership")
    
    # Application permissions
    APPLICATIONS_READ = Permission(PermissionCategory.APPLICATIONS, "read", "View applications")
    APPLICATIONS_CREATE = Permission(PermissionCategory.APPLICATIONS, "create", "Create new applications")
    APPLICATIONS_UPDATE = Permission(PermissionCategory.APPLICATIONS, "update", "Update application settings")
    APPLICATIONS_DELETE = Permission(PermissionCategory.APPLICATIONS, "delete", "Delete applications")
    APPLICATIONS_MANAGE_KEYS = Permission(PermissionCategory.APPLICATIONS, "manage_keys", "Manage API keys")
    APPLICATIONS_MANAGE_ENVS = Permission(PermissionCategory.APPLICATIONS, "manage_environments", "Manage environments")
    ...
    SETTINGS_ENCRYPTION = Permission(PermissionCategory.SETTINGS, "encryption", "Manage encryption settings")
    SETTINGS_INTEGRATIONS = Permission(PermissionCategory.SETTINGS, "integrations", "Manage integrations")
    ...
    SECURITY_MANAGE_KEYS = Permission(PermissionCategory.SECURITY, "manage_keys", "Manage encryption keys")
