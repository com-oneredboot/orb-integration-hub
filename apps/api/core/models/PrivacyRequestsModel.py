...
Generated at 2025-07-14T18:03:31.271018
"""
...
class PrivacyRequestsUpdateInput(BaseModel):
    ...
    received_at: Optional[datetime] = Field(
        None, description="When the privacy request was received"
    )
    ...
    updated_at: Optional[datetime] = Field(
        None, description="When the privacy request was last updated"
    )
