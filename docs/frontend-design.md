...
*   **Generated Models:** Strictly use models generated by `orb-schema-generator` located in `apps/web/src/app/core/models/` for type safety in API interactions and data display.
