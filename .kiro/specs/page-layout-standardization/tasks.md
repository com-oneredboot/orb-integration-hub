...
- [x] 10.1 Write integration test for Application Detail page
  - Test that page uses TabNavigationComponent
...
- [x] 11. Migrate Organization Detail page (4 tabs with badges)
...
- [x] 11.1 Write integration test for Organization Detail page
  - Test that page uses TabNavigationComponent
