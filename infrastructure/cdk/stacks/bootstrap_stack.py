            ...
            statements=[
                iam.PolicyStatement(
                    ...
                    resources=[
                        ...
                        f"arn:aws:logs:{self.region}:{self.account}:log-group:/audit/{self.config.environment}",
                        f"arn:aws:logs:{self.region}:{self.account}:log-group:/audit/{self.config.environment}:log-stream:*",
                    ],
                ),
            ],
        )
