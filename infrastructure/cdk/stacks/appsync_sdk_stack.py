...
class AppSyncSdkStack(Stack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._add_data_sources(dynamodb_stack)
    ...
    def _add_data_sources(self, dynamodb_stack: DynamoDBStack) -> None:
        ...
        for table_name, table in sdk_tables.items():
            ...
            self._add_table_resolvers(data_source, table_name)
