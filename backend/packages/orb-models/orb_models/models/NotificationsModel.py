...
Generated at 2025-07-25T21:36:32.502958+00:00
"""
...
class NotificationsUpdateInput(BaseModel):
    ...
    notification_id: Optional[str] = Field(
        None, description="Unique identifier for the notification (primary key)"
    )
    ...
    status: Optional[NotificationStatus] = Field(
        None, description="Current status of the notification"
    )
...
class Notifications(BaseModel):
    ...
    def from_dto(cls, dto: dict) -> "Notifications":
        return cls(
            ...
            type=(
                NotificationType[dto.get("type", "NotificationType.UNKNOWN")]
                if dto.get("type")
                else NotificationType.UNKNOWN
            ),
            status=(
                NotificationStatus[dto.get("status", "NotificationStatus.UNKNOWN")]
                if dto.get("status")
