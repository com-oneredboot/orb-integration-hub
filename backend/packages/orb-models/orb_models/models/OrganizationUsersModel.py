...
Generated at 2025-07-25T21:36:32.608952+00:00
"""
...
class OrganizationUsersCreateInput(BaseModel):
    ...
    status: OrganizationUserStatus = Field(
...
class OrganizationUsersUpdateInput(BaseModel):
    ...
    user_id: Optional[str] = Field(
        None, description="ID of the user (foreign key to Users, partition key)"
    )

    organization_id: Optional[str] = Field(
        None, description="ID of the organization (foreign key to Organizations, sort key)"
    )
    ...
    status: Optional[OrganizationUserStatus] = Field(
        None, description="Current status of the user's membership in the organization"
    )
...
class OrganizationUsers(BaseModel):
    ...
    def from_dto(cls, dto: dict) -> "OrganizationUsers":
        return cls(
            ...
            role=(
                OrganizationUserRole[dto.get("role", "OrganizationUserRole.UNKNOWN")]
                if dto.get("role")
