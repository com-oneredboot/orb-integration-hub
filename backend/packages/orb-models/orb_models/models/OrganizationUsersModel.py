...
Generated at 2025-08-10T00:38:11.825717+00:00
"""
...
class OrganizationUsers(BaseModel):
    ...
    role: str = Field(..., description="Role of the user within the organization (OWNER is determined by Organizations.ownerId field)")

    status: str = Field(..., description="Current status of the user's membership in the organization")

    invited_by: str = Field(None, description="ID of the user who sent the invitation (for audit trail)")
