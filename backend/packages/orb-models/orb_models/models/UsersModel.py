...
Generated at 2025-08-10T00:38:11.982870+00:00
"""
...
class Users(BaseModel):
    ...
    phone_number: str = Field(None, description="User's phone number")

    groups: List[str] = Field(None, description="List of Cognito groups the user belongs to (used for AppSync @aws_auth)")
    ...
    mfa_enabled: bool = Field(None, description="Whether multi-factor authentication is enabled for the user")

    mfa_setup_complete: bool = Field(None, description="Whether MFA setup has been completed successfully")
