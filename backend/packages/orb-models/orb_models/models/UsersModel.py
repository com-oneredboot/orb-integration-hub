...
Generated at 2025-07-25T21:36:32.740204+00:00
"""
...
class UsersUpdateInput(BaseModel):
    ...
    cognito_sub: Optional[str] = Field(
        None, description="Cognito user sub (unique identifier from tokens)"
    )
...
class Users(BaseModel):
    ...
    def from_dto(cls, dto: dict) -> "Users":
        return cls(
            ...
            status=(
                UserStatus[dto.get("status", "UserStatus.UNKNOWN")]
                if dto.get("status")
