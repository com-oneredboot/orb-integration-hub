...
Generated at 2025-08-10T00:38:12.000531+00:00
"""
...
class SmsVerification(BaseModel):
    ...
    code: float = Field(None, description="the confirmation Code")

    valid: bool = Field(None, description="whether the provided code is valid (returned during verification)")
