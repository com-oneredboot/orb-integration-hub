...
Generated at 2025-07-25T21:36:32.713189+00:00
"""
...
class ApplicationsUpdateInput(BaseModel):
    ...
    application_id: Optional[str] = Field(
        None, description="Unique identifier for the application (primary key)"
    )
    ...
    owner_id: Optional[str] = Field(
        None, description="ID of the user who owns the application (foreign key to Users)"
    )
...
class Applications(BaseModel):
    ...
    def from_dto(cls, dto: dict) -> "Applications":
        return cls(
            ...
            status=(
                ApplicationStatus[dto.get("status", "ApplicationStatus.UNKNOWN")]
                if dto.get("status")
