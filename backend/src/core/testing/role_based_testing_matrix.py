...
class RoleBasedTestingMatrix:
    ...
    def _initialize_permission_rules(self) -> Dict[OrganizationUserRole, PermissionRule]:
        ...
        return {
            OrganizationUserRole.OWNER: PermissionRule(
                ...
                permissions={
                    PermissionType.ORG_VIEW, PermissionType.ORG_MANAGE, PermissionType.ORG_DELETE,
                    PermissionType.ORG_BILLING, PermissionType.USER_INVITE, PermissionType.USER_REMOVE,
                    PermissionType.USER_ROLE_ASSIGN, PermissionType.USER_ROLE_REVOKE, PermissionType.USER_VIEW,
                    PermissionType.APP_CREATE, PermissionType.APP_VIEW, PermissionType.APP_MANAGE,
                    PermissionType.APP_DELETE, PermissionType.APP_DEPLOY, PermissionType.DATA_READ,
                    PermissionType.DATA_WRITE, PermissionType.DATA_DELETE, PermissionType.DATA_EXPORT,
                    PermissionType.AUDIT_VIEW, PermissionType.AUDIT_EXPORT, PermissionType.COMPLIANCE_VIEW,
            ...
            OrganizationUserRole.ADMIN: PermissionRule(
                ...
                permissions={
                    PermissionType.ORG_VIEW, PermissionType.ORG_MANAGE, PermissionType.USER_INVITE,
                    PermissionType.USER_REMOVE, PermissionType.USER_ROLE_ASSIGN, PermissionType.USER_VIEW,
                    PermissionType.APP_CREATE, PermissionType.APP_VIEW, PermissionType.APP_MANAGE,
                    PermissionType.APP_DELETE, PermissionType.APP_DEPLOY, PermissionType.DATA_READ,
                    PermissionType.DATA_WRITE, PermissionType.DATA_DELETE, PermissionType.DATA_EXPORT,
                    PermissionType.AUDIT_VIEW, PermissionType.COMPLIANCE_VIEW, PermissionType.SYSTEM_MONITOR
                },
                restrictions={
                    PermissionType.ORG_DELETE, PermissionType.ORG_BILLING, 
                    PermissionType.USER_ROLE_REVOKE, PermissionType.AUDIT_EXPORT, 
            ...
            OrganizationUserRole.MEMBER: PermissionRule(
                ...
                permissions={
                    PermissionType.ORG_VIEW, PermissionType.USER_VIEW, PermissionType.APP_VIEW,
                    PermissionType.APP_MANAGE, PermissionType.DATA_READ, PermissionType.DATA_WRITE,
                    PermissionType.DATA_EXPORT
                },
                restrictions={
                    PermissionType.ORG_MANAGE, PermissionType.ORG_DELETE, PermissionType.ORG_BILLING,
                    PermissionType.USER_INVITE, PermissionType.USER_REMOVE, PermissionType.USER_ROLE_ASSIGN,
                    PermissionType.USER_ROLE_REVOKE, PermissionType.APP_CREATE, PermissionType.APP_DELETE,
                    PermissionType.APP_DEPLOY, PermissionType.DATA_DELETE, PermissionType.AUDIT_VIEW,
                    PermissionType.AUDIT_EXPORT, PermissionType.COMPLIANCE_VIEW, PermissionType.SYSTEM_CONFIG,
            ...
            OrganizationUserRole.GUEST: PermissionRule(
                ...
                permissions={
                    PermissionType.ORG_VIEW, PermissionType.APP_VIEW, PermissionType.DATA_READ
                },
                restrictions={
                    PermissionType.ORG_MANAGE, PermissionType.ORG_DELETE, PermissionType.ORG_BILLING,
                    PermissionType.USER_INVITE, PermissionType.USER_REMOVE, PermissionType.USER_ROLE_ASSIGN,
                    PermissionType.USER_ROLE_REVOKE, PermissionType.USER_VIEW, PermissionType.APP_CREATE,
                    PermissionType.APP_MANAGE, PermissionType.APP_DELETE, PermissionType.APP_DEPLOY,
                    PermissionType.DATA_WRITE, PermissionType.DATA_DELETE, PermissionType.DATA_EXPORT,
                    PermissionType.AUDIT_VIEW, PermissionType.AUDIT_EXPORT, PermissionType.COMPLIANCE_VIEW,
                    PermissionType.SYSTEM_CONFIG, PermissionType.SYSTEM_MONITOR
                },
    ...
    def get_role_permissions(
        ...
        if include_inherited and rule.inheritance:
            for role, level in self.role_hierarchy.items():
                if (level < self.role_hierarchy[user_role] and 
                    role in self.permission_rules):
    ...
    def compare_role_permissions(
        self,
        role1: OrganizationUserRole,
        role2: OrganizationUserRole
            ...
            for org_status in OrganizationStatus:
                for user_status in OrganizationUserStatus:
                    ...
                    scenario = TestScenario(
                        ...
                        tags={f"role_{role.value.lower()}", f"action_{action.value}", f"org_{org_status.value.lower()}"},
            ...
            for target_role in OrganizationUserRole:
                for action in role_modification_actions:
                    ...
                    scenario = TestScenario(
                        ...
                        tags={"cross_role", f"actor_{actor_role.value.lower()}", f"target_{target_role.value.lower()}"},
    ...
    def _generate_edge_case_scenarios(self, start_id: int) -> List[TestScenario]:
        ...
        edge_cases = [
            ...
            (OrganizationUserRole.ADMIN, OrganizationUserStatus.INACTIVE, 
             OrganizationStatus.ACTIVE, ActionType.VIEW_APPLICATION, False),
            (OrganizationUserRole.OWNER, OrganizationUserStatus.PENDING, 
             OrganizationStatus.ACTIVE, ActionType.CREATE_APPLICATION, False),
            
            # Inactive organization scenarios
            (OrganizationUserRole.ADMIN, OrganizationUserStatus.ACTIVE, 
             OrganizationStatus.INACTIVE, ActionType.CREATE_APPLICATION, False),
            (OrganizationUserRole.OWNER, OrganizationUserStatus.ACTIVE, 
             OrganizationStatus.SUSPENDED, ActionType.DELETE_ORGANIZATION, False),
            
            # Special permission scenarios
            (OrganizationUserRole.MEMBER, OrganizationUserStatus.ACTIVE, 
             OrganizationStatus.ACTIVE, ActionType.READ_DATA, True),
            (OrganizationUserRole.GUEST, OrganizationUserStatus.ACTIVE, 
             OrganizationStatus.ACTIVE, ActionType.WRITE_DATA, False),
        ]
        ...
        for role, user_status, org_status, action, expected_result in edge_cases:
            scenario = TestScenario(
                ...
                context={
                    "test_type": "edge_case",
                    "inactive_entity": user_status != OrganizationUserStatus.ACTIVE or org_status != OrganizationStatus.ACTIVE
                },
                tags={"edge_case", f"role_{role.value.lower()}", f"status_{user_status.value.lower()}"},
                priority="high"
            )
    ...
    def _determine_expected_result(
        ...
        if (user_status != OrganizationUserStatus.ACTIVE or 
            org_status not in [OrganizationStatus.ACTIVE]):
            return False
    ...
    def _can_role_modify_role(
        ...
        actor_level = self.role_hierarchy[actor_role]
    ...
    def analyze_permission_matrix(self) -> Dict[str, Any]:
        ...
        for scenario in self.test_scenarios:
            ...
            analysis["scenarios_by_priority"][priority] = analysis["scenarios_by_priority"].get(priority, 0) + 1
            ...
            analysis["scenarios_by_action"][action] = analysis["scenarios_by_action"].get(action, 0) + 1
    ...
    def _identify_security_risks(self) -> List[Dict[str, Any]]:
        ...
        for role in OrganizationUserRole:
            ...
            if role_dangerous_perms and role in [OrganizationUserRole.MEMBER, OrganizationUserRole.GUEST]:
                risks.append({
            ...
            "recommended_execution_order": [
                {
                    ...
                    "scenarios": [s.scenario_id for s in critical_scenarios[:10]]  # Limit for readability
                },
                {
