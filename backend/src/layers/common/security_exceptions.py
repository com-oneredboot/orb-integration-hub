# file: backend/src/layers/common/security_exceptions.py
# author: AI Assistant
# created: 2025-07-17
# description: Security-specific exceptions that extend the base OrbError

"""
Security-specific exceptions for the ORB Integration Hub backend.

These exceptions extend the base OrbError and provide security-focused
error handling for authentication, authorization, and compliance.
"""

from typing import Any, Dict, Optional, List
from .exceptions import OrbError
