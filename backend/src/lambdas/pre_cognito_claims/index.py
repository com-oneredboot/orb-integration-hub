...
# created: 2025-02-16
# description: This is the lambda function that will add custom claims to the JWT token before it is generated by Cognito.
...
# Local Imports
from authentication_dynamodb import CoreDynamoDBService, DatabaseError
