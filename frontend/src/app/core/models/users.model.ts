...
// Model Class
export class User implements IUser {  user_id: string = '';  cognito_id: string = '';  email: string = '';  phone_number: string = '';  phone_verified: boolean = false;  first_name: string = '';  last_name: string = '';  groups: string[] = [];  status: UserStatus = UserStatus.UNKNOWN;  created_at: timestamp;  updated_at: timestamp;
