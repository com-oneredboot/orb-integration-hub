...
// Interface
export interface IApplication_role {  application_id: string;  role_id: string;  description: string?;  status: ApplicationRoleStatus;  created_at: timestamp;  updated_at: timestamp;}

// Model Class
export class Application_role implements IApplication_role {  application_id: string = '';  role_id: string = '';  description: string = '';  status: ApplicationRoleStatus = ApplicationRoleStatus.UNKNOWN;  created_at: timestamp;  updated_at: timestamp;
